...
Every one of those still queues the same stale wake on the same cadence, so the reading decides how loudly a pane is reported and never whether it is reported.
