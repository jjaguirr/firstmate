...
state/               runtime records and signals; gitignored
  ...
  .quota-scan .quota-probe.json .quota-probe.json.providers .quota-catalog.json .quota-probe-resume.*  the per-home scan cadence marker, cached quota-axi evidence and the provider set it was fetched for, and the private snapshot one resume reads its account from; safe to delete
