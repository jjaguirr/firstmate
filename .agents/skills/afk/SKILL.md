...
The one declared wait that library does not own is a recorded provider quota refusal, whose predicate lives the same way in the shared `bin/fm-quota-lib.sh`.
